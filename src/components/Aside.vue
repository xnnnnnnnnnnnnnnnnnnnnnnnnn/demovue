<template>
  ...
  >
    ...
    <el-submenu index="/">
      ...
      <el-menu-item-group>
        <el-menu-item index="/admin/userManage"><i class="el-icon-s-custom"/>用户信息</el-menu-item>
      </el-menu-item-group>
      <el-menu-item-group>
        <el-menu-item index="/admin/supplierManage"><i class="el-icon-s-custom"/>商户信息</el-menu-item>
      </el-menu-item-group>
    </el-submenu>
    <el-submenu index="/">
    ...
    <el-submenu index="/">
      ...
      <el-menu-item-group>
        <el-menu-item index="/admin/transportManage"><i class="el-icon-setting"/>运输信息</el-menu-item>
      </el-menu-item-group>
    </el-submenu>
    <el-submenu index="/">
      <template slot="title"><i class="el-icon-s-shop"></i><span slot="title">食品信息</span></template>
      <el-menu-item-group>
        <el-menu-item index="/admin/foodManage"><i class="el-icon-s-shop"/>食品信息</el-menu-item>
      </el-menu-item-group>
    </el-submenu>
  </el-menu>
</template>
